...
INSERT IGNORE INTO `PREFIX_productfeed` (`id_product`, `is_sticky`, `is_active`, `pushed_at`, `date_add`, `date_upd`)
SELECT p.`id_product`, 0, 1, p.`date_add`, p.`date_add`, p.`date_upd`
