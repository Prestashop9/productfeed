<article class="pf-card{if $product.is_sticky} pf-card--sticky{/if}" data-id="{$product.id_product}">
    ...
    <div class="pf-card__actions">
        <div class="pf-card__actions-left">
            <button class="pf-card__action-btn pf-like-btn" data-id="{$product.id_product}" aria-label="{l s='Like' d='Modules.Productfeed.Shop'}">
            ...
            <button class="pf-card__action-btn pf-save-btn" data-id="{$product.id_product}" aria-label="{l s='Save' d='Modules.Productfeed.Shop'}">
